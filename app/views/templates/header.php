...
<head>
  ...
  <title>PerpustakaanDigital | <?= getTitle(); ?></title>
...
<div class="wrapper">
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
        ...
        <div class="info">
          <h5>Selamat Datang<a href="#" class="d-block text-success"><?= $_SESSION['username']; ?></a></h5>
  ...
  <path d="M4.268 1A2 2 0 0 1 6 0h6a2 2 0 0 1 2 2v11.5a.5.5 0 0 1-.777.416L13 13.768V2a1 1 0 0 0-1-1z"/>
          ...
          <li style=" position:absolute; top: 420px;"class="nav-item">
